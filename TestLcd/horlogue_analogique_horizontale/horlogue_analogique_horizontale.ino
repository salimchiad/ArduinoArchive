...
void loop(void) {
  if (Serial.available()) {      // Look for char in serial que and process if found
    ...
    tft.drawCircle(w/2, w/2, w*D, WHITE);

    tft.drawLine(w/2, w/2, (w/2)+((w*S)*sin(pSec*0.104717)),(w/2)+((w*S)*-cos(pSec*0.104717)), BLACK);
    tft.drawLine(w/2, w/2, (w/2)+((w*S)*sin(Sec*0.104717)),(w/2)+((w*S)*-cos(Sec*0.104717)), BLUE);
    tft.drawLine(w/2, w/2, (w/2)+((w*M)*sin(pMin*0.104717)),(w/2)+((w*M)*-cos(pMin*0.104717)), BLACK);
    tft.drawLine(w/2, w/2, (w/2)+((w*M)*sin(Min*0.104717)),(w/2)+((w*M)*-cos(Min*0.104717)), GREEN);
    tft.drawLine(w/2, w/2, (w/2)+((w*H)*sin(pHour*0.52359878)),(w/2)+((w*H)*-cos(pHour*0.52359878)), BLACK);
    tft.drawLine(w/2, w/2, (w/2)+((w*H)*sin(Hour*0.52359878)),(w/2)+((w*H)*-cos(Hour*0.52359878)), RED);

    for(int i=0; i<60; i++){
      tft.drawLine((w/2)+((w*D)*sin(i*0.104717)), (w/2)+((w*D)*-cos(i*0.104717)), (w/2)+((w*pM)*sin(i*0.104717)),(w/2)+((w*pM)*-cos(i*0.104717)), CYAN);
    }

    for(int i=0; i<12; i++){
      tft.drawLine((w/2)+((w*D)*sin(i*0.52359878)), (w/2)+((w*D)*-cos(i*0.52359878)), (w/2)+((w*pH)*sin(i*0.52359878)),(w/2)+((w*pH)*-cos(i*0.52359878)), YELLOW);
    }
