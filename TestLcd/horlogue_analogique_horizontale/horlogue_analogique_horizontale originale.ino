...
float pSec, pMin, pHour, Sec, Min, Hour;
...
void loop(void) {
  if (Serial.available()) {      // Look for char in serial que and process if found
    ...
    tft.drawCircle(w/2, w/2, w/2.01, WHITE);

    tft.drawLine(w/2, w/2, (w/2)+((w*0.49)*sin(pSec*0.104717)),(w/2)+((w*0.49)*-cos(pSec*0.104717)), BLACK);
        tft.drawLine(w/2, w/2, (w/2)+((w*0.49)*sin(Sec*0.104717)),(w/2)+((w*0.49)*-cos(Sec*0.104717)), BLUE);
    tft.drawLine(w/2, w/2, (w/2)+((w*0.35)*sin(pMin*0.104717)),(w/2)+((w*0.35)*-cos(pMin*0.104717)), BLACK);
        tft.drawLine(w/2, w/2, (w/2)+((w*0.35)*sin(Min*0.104717)),(w/2)+((w*0.35)*-cos(Min*0.104717)), GREEN);
    tft.drawLine(w/2, w/2, (w/2)+((w*0.25)*sin(pHour*0.52359878)),(w/2)+((w*0.25)*-cos(pHour*0.52359878)), BLACK);
        tft.drawLine(w/2, w/2, (w/2)+((w*0.25)*sin(Hour*0.52359878)),(w/2)+((w*0.25)*-cos(Hour*0.52359878)), RED);

    for(int i=0; i<60; i++){
      tft.drawLine((w/2)+((w*0.49)*sin(i*0.104717)), (w/2)+((w*0.49)*-cos(i*0.104717)), (w/2)+((w*0.48)*sin(i*0.104717)),(w/2)+((w*0.48)*-cos(i*0.104717)), CYAN);
    }

    for(int i=0; i<12; i++){
      tft.drawLine((w/2)+((w*0.45)*sin(i*0.52359878)), (w/2)+((w*0.45)*-cos(i*0.52359878)), (w/2)+((w*0.49)*sin(i*0.52359878)),(w/2)+((w*0.49)*-cos(i*0.52359878)), YELLOW);
    }
